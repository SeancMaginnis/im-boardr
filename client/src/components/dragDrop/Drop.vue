<template>
  <component :is="tag" @dragenter="emitEvent(events.dragenter, $event)" @dragleave="emitEvent(events.dragleave, $event)"
    @dragover.prevent="emitEvent(events.dragover, $event)" @drop.prevent="emitEvent(events.drop, $event)">
